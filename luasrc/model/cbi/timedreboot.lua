...
m = Map("timedreboot",translate("Timed Reboot"),translate("Timed Reboot Setting.") .. [[<br/><br/><a href="https://github.com/kongfl888/luci-app-timedreboot" target="_blank">Powered by kongfl888</a>]])

s = m:section(NamedSection,"config","timedreboot")
s.addremove = false
s.anonymous = true
